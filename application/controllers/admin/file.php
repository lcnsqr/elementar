...
class File extends CI_Controller {
	...
	function manager()
	{
		...
		$this->load->view('admin/admin_file', $data);
	}
	...
	function _render_tree_folder($path, $current = NULL, $tree = NULL, $tree_dir = NULL)
	{
		...
		$data['tree'] = $tree;
		$html = $this->load->view('admin/admin_file_tree', $data, true);
		return $html;
	}
	...
	function _render_listing($path)
	{
		...
		$html = $this->load->view('admin/admin_file_listing', $data, true);
		return $html;
	}
	...
	function xhr_render_upload_form()
	{
		...
		$form = form_open_multipart("/admin/file/upload", $attributes, $hidden);
		/*
		 * Open file field
		 */
		$attributes = array(
		...
		$html = $this->load->view('admin/admin_file_upload', $data, TRUE); 
	...
	function xhr_read_upload_status()
	{
		...
		if ( (bool) $done )
		{
			...
			$html = $this->load->view('admin/admin_file_uploaded', $data, TRUE); 
